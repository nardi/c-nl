...
geheel_getal hoofdfunctie(geheel_getal aantal_argumenten, karakter wijzer wijzer argumenten)
{
    ...
    als (aantal_argumenten groter is dan 1)
        druk_in_vorm("Dit zijn de argumenten die je meegegeven hebt:\n");
    doe_iets_en_zolang_iets_geldt_doe_iets_anders(teller wordt 1; teller is kleiner dan aantal_argumenten; verhoog teller)
    {
